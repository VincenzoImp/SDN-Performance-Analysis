...
class Mininet( object ):
    ...
    def iperf( self, hosts=None, l4Type='TCP', udpBw='10M', fmt=None,
        ...
        servout = ''
        # We want the valid *b/sec from the iperf server output
        # for TCP, there are two of them in older versions because of
        # waitListening and even in newer there is sometimes one with 0/0
        # Selecting a non-empty result allows to wait for the result no matter
        # if one or two will appear
