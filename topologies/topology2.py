...
class Network_Topology(Topo):
    ...
    def build(self, **opts):
        ...
        self.addLink(s1, s3, port1=3, port2=4, bw=self.BW, delay='20ms', max_queue_size=10)
    ...
    def run(self, rate_pkts_s):
        ...
        links_utilization['s3s1'] = self.compute_utilization(switches_data['s3'], 4)
...
if __name__=='__main__':
    ...
    try:
        ...
        print()
        print()
        print("testing topology2 with lambda {}".format(rate_pkts_s))
        ...
        print("usage: ./topologies/topology2.py <lambda-rate>")
